...
class OrderDetailsPage extends StatelessWidget {
  ...
  // 🎨 Helper to get Delivery Status color (Synced with manage_orders.dart)
  Color _getStatusColor(String status) {
    switch (status.toUpperCase()) {
      case 'PENDING':
        return Colors.orange; // Requesting
      case 'APPROVED':
        return Colors.green; // Packaging
      case 'DELIVERING':
        return Colors.blueAccent; // Delivering
      case 'DELIVERED':
  ...
  // 📝 Helper to get Display Name (Synced with manage_orders.dart)
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(color: orderStatusColor, borderRadius: BorderRadius.circular(20)),
                                child: Text(
                                  orderStatus,
                                  style: GoogleFonts.openSans(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.white),
                                ),
                              ),
                            ],
                          ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ...
                                  style: GoogleFonts.openSans(fontSize: 12, fontWeight: FontWeight.bold, color: _getStatusColor(deliveryStatus)),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    child: Text(
                                      order['payment_method'] ?? "Payment Successful",
                                      overflow: TextOverflow.ellipsis,
                                      style: GoogleFonts.openSans(fontSize: 12, fontWeight: FontWeight.w600, color: const Color(0xFF003366)),
                                    ),
                                  ),
                                ],
                              ),
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: item['image_url'] != null
                                    ? Image.network(item['image_url'], width: 60, height: 60, fit: BoxFit.cover, errorBuilder: (c, e, s) => const Icon(Icons.medication, size: 40))
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(item['name'] ?? "Unknown", style: GoogleFonts.openSans(fontWeight: FontWeight.bold, fontSize: 15)),
                                    Text("Qty: ${item['quantity'] ?? 1}", style: GoogleFonts.openSans(fontSize: 13, color: Colors.grey)),
                                  ],
                                ),
                              ),
                              Text(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(isFree ? "Applied" : "RM ${amount.toStringAsFixed(2)}", style: GoogleFonts.openSans(fontSize: 14, fontWeight: FontWeight.bold)),
        ],
      ),
    );
  }
